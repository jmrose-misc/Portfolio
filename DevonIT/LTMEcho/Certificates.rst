...
=======
Appliance can push these security certificates to multiple devices.
>>>>>>> 32bbbf420bac2c69413bc346d597ac0b362b634e
...
<<<<<<< HEAD
       ...
       `.key`, `p7b`, and `.pem`.
=======
       A certificate must be locally stored in order for the Management Appliance 
       to use it. Clicking on the **Browse** button to locate the certificate file 
       for use. The following certificate types are accepted: `.cer`, `.crt`, 
       `.csr`, `.key`, `p7b`, and `.pem`.
>>>>>>> 32bbbf420bac2c69413bc346d597ac0b362b634e
